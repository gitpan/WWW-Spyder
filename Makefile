...
TO_INST_PM = Spyder.pm

PM_TO_BLIB = Spyder.pm \
	$(INST_LIB)/WWW/Spyder.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  Spyder.pm $(INST_MAN3DIR)/WWW::Spyder.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/WWW/Spyder.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'version:      0.20' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Spyder.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Spyder.pm $(INST_LIB)/WWW/Spyder.pm 
	$(NOECHO) $(TOUCH) $@
